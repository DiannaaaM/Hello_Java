public class Objects_b1 {
    public static void Main(String[] args){
        Author first_author = new Author("Лия", "Арден");
        Book first_book = new Book("Золото в темной ночи",2017, first_author);
        Author second_author = new Author("Ребека", "Ярос");
        Book second_book = new Book("Четвертое крыло", 2024, second_author);
